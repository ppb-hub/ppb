...
export default async function HomePage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return (
    <>
      ...
      {/* NÚMEROS */}
      <section className="bg-[#F8F9FA] dark:bg-[#c93239]/60 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl font-bold text-[#c93239] dark:text-white font-['Montserrat']">{ui.home.statsTitle}</h2>
      ...
      <section className="py-16 bg-white dark:bg-[#0a1628]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-10 gap-4">
            <div>
              <h2 className="text-2xl sm:text-3xl font-bold text-[#c93239] dark:text-white font-['Montserrat']">{ui.home.featuredTitle}</h2>
      ...
      <section className="py-20 bg-[#c93239] relative overflow-hidden">
      ...
      <section className="py-16 bg-white dark:bg-[#0a1628]">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 text-center">
          ...
          <h2 className="text-2xl font-bold text-[#c93239] dark:text-white font-['Montserrat'] mb-2">{ui.home.alertTitle}</h2>
