...
export default async function LangNotFound({ params }: { params?: Promise<{ lang: string }> }) {
  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center px-4 text-center py-24">
      <div className="text-7xl font-bold text-[#c93239] dark:text-[#D4A843] font-['Montserrat'] mb-4">404</div>
      <h1 className="text-2xl font-bold text-[#c93239] dark:text-white font-['Montserrat'] mb-3">
      ...
      <div className="flex gap-3">
        ...
        <Link href={localizedHref(locale, "projects")} className="px-6 py-3 border border-gray-300 dark:border-white/20 text-[#c93239] dark:text-white rounded-xl hover:bg-gray-50 dark:hover:bg-white/5">
