...
export default function LangError({
  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center px-4 text-center py-24">
      <div className="text-6xl font-bold text-[#c93239] dark:text-[#D4A843] font-['Montserrat'] mb-4">500</div>
      ...
      <div className="flex gap-3">
        ...
        <Link
          ...
          className="px-6 py-3 border border-gray-300 dark:border-white/20 text-[#c93239] dark:text-white rounded-xl hover:bg-gray-50 dark:hover:bg-white/5 transition-colors"
        >
