          ...
          <div className="min-w-0">
            ...
            {objectives.length > 0 && (
              <section className="mb-8" aria-labelledby="objectivos">
                <h2 id="objectivos" className="text-xl font-bold text-[#850b0b] dark:text-white font-['Montserrat'] mb-4">{ui.detail.objectives}</h2>
            ...
            {benefits.length > 0 && (
              <section className="mb-8" aria-labelledby="beneficios">
                <h2 id="beneficios" className="text-xl font-bold text-[#850b0b] dark:text-white font-['Montserrat'] mb-4">{ui.detail.benefits}</h2>
                <ul className="space-y-2">
                  {benefits.map((obj) => (
                    <li key={obj.id} className="flex items-start gap-2.5 text-gray-600 dark:text-white/70">
                      <CheckCircle2 size={17} className="text-[#27AE60] mt-0.5 shrink-0" aria-hidden="true" />
