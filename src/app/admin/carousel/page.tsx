  ...
  return (
    <div className="space-y-5 max-w-4xl">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="text-2xl font-bold text-[#c93239] dark:text-white font-['Montserrat']">Imagens do Hero</h1>
    ...
    <Card
      ...
      actions={
        <div className="flex items-center gap-1">
          <button onClick={() => onMove(-1)} disabled={position === 1} aria-label="Mover para cima" className="p-1.5 rounded-lg text-gray-500 hover:text-[#c93239] hover:bg-gray-100 dark:hover:bg-white/10 disabled:opacity-30 transition-colors">
            <ArrowUp size={14} />
          </button>
          <button onClick={() => onMove(1)} disabled={position === total} aria-label="Mover para baixo" className="p-1.5 rounded-lg text-gray-500 hover:text-[#c93239] hover:bg-gray-100 dark:hover:bg-white/10 disabled:opacity-30 transition-colors">
            <ArrowDown size={14} />
          </button>
