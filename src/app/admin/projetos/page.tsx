  ...
  return (
    <div className="space-y-5">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="text-2xl font-bold text-[#c93239] dark:text-white font-['Montserrat']">Projetos</h1>
            ...
            {rows.map((p) => (
              <tr key={p.id} className="hover:bg-gray-50/60 dark:hover:bg-white/5">
                <td className="py-2.5 pr-4 max-w-[280px]">
                  <span className="block font-medium text-[#c93239] dark:text-white truncate">{p.title_pt}</span>
      ...
      {deleting && (
        <Confirm
          ...
          text={`O projeto “${deleting.title}” e os seus objectivos, imagens e documentos serão eliminados definitivamente.`}
