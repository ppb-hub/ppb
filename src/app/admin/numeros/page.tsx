...
export default function AdminStatsPage() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <h1 className="text-2xl font-bold text-[#c93239] dark:text-white font-['Montserrat']">Números da Homepage</h1>
          ...
          <Table head={["Rótulo (PT)", "Valor", "Sufixo", "Visível", "Ações"]}>
            {rows.map((s) => (
              <tr key={s.id} className="hover:bg-gray-50/60 dark:hover:bg-white/5">
                <td className="py-2.5 pr-4 font-medium text-[#c93239] dark:text-white">{s.label_pt}</td>
