...
function LoginForm() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#c93239] px-4 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md">
        <div className="text-center mb-8">
          <div className="inline-flex w-14 h-14 rounded-2xl bg-[#D4A843] items-center justify-center mb-4 shadow-lg">
            <span className="text-[#c93239] font-bold font-['Montserrat']">GPB</span>
          </div>
        ...
        <form onSubmit={submit} className="bg-white dark:bg-[#c93239]/40 rounded-2xl p-6 sm:p-8 shadow-2xl space-y-4">
          {error && (
          ...
          <div>
            <label htmlFor="username" className="block text-sm font-medium text-[#c93239] dark:text-white mb-1.5">Utilizador</label>
          ...
          <div>
            <label htmlFor="password" className="block text-sm font-medium text-[#c93239] dark:text-white mb-1.5">Palavra-passe</label>
            <div className="relative">
