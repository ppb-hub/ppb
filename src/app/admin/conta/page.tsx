...
export default function AdminAccountPage() {
  ...
  return (
    <div className="space-y-6 max-w-3xl">
      <div>
        <h1 className="text-2xl font-bold text-[#c93239] dark:text-white font-['Montserrat']">Conta & Acessos</h1>
      ...
      <Card title="Sessão atual">
        <dl className="grid sm:grid-cols-2 gap-4 text-sm">
          <div>
            ...
            <dd className="text-[#c93239] dark:text-white font-medium">{user?.username ?? "—"}</dd>
          </div>
          <div>
            <dt className="text-[10px] uppercase tracking-wide text-gray-400 font-semibold">E-mail</dt>
            <dd className="text-[#c93239] dark:text-white">{user?.email ?? "—"}</dd>
          </div>
          <div>
          ...
          <div>
            ...
            <dd className="text-[#c93239] dark:text-white">{user?.is_superuser ? "Superutilizador" : "Administrador"}</dd>
          </div>
        </dl>
      </Card>
