...
export default function RootError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white dark:bg-[#0a1628] px-4 text-center">
      ...
      <h1 className="text-2xl font-bold text-[#c93239] dark:text-white font-['Montserrat'] mb-3">Erro inesperado</h1>
      ...
      <div className="flex gap-3">
        ...
        <Link href="/pt" className="px-6 py-3 border border-gray-300 dark:border-white/20 text-[#c93239] dark:text-white rounded-xl">
          Início
        </Link>
      </div>
    </div>
