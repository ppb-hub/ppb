...
const pt: UiStrings = {
  ...
  search: { placeholder: "Pesquisar projetos...", aria: "Pesquisar" },
  ...
  projects: {
    ...
    showing: "Mostrando {from}–{to} de {total} projetos",
  ...
  about: {
    ...
    ctaTitle: "Conheça os nossos projetos",
    ctaText: "Explore todos os projetos em curso nos municípios de Benguela.",
