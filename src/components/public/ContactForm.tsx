...
const Field = memo(function Field({
  ...
  return (
    <div>
      <label className="block text-sm font-medium text-[#c93239] dark:text-white mb-1.5">
        {label}
  ...
  if (submitted) {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center">
        ...
        <h2 className="text-2xl font-bold text-[#c93239] dark:text-white font-['Montserrat'] mb-3">{ui.contact.successTitle}</h2>
  ...
  return (
    <div className="grid lg:grid-cols-[1fr_320px] gap-10">
        ...
        <form onSubmit={handleSubmit} noValidate className="space-y-5">
          ...
          <Field label={ui.contact.captcha} required error={errors.math}>
            <div className="flex items-center gap-3">
              <span className="text-sm font-medium text-[#c93239] dark:text-white bg-[#F8F9FA] dark:bg-white/10 px-4 py-2.5 rounded-xl border border-gray-200 dark:border-white/20">
                {captcha.a} + {captcha.b} =
              </span>
              <input
                name="math"
      ...
      <div className="space-y-5">
        <div className="bg-[#F8F9FA] dark:bg-[#c93239]/30 rounded-2xl p-6 border border-gray-100 dark:border-white/10">
          <h3 className="font-bold text-[#c93239] dark:text-white font-['Montserrat'] mb-5">{ui.contact.sidebarTitle}</h3>
          <div className="space-y-4">
            <a href={`tel:${sidebar.phone.replace(/[^\d+]/g, "")}`} className="flex items-start gap-3 group">
              <span className="w-9 h-9 bg-[#c93239] rounded-lg flex items-center justify-center shrink-0">
              ...
              <span>
                ...
                <span className="block text-sm font-medium text-[#c93239] dark:text-white group-hover:text-[#E8821A] transition-colors">{sidebar.phone}</span>
              </span>
            </a>
            <a href={`mailto:${sidebar.email}`} className="flex items-start gap-3 group">
              ...
              <span>
                ...
                <span className="block text-sm font-medium text-[#c93239] dark:text-white group-hover:text-[#E8821A] transition-colors">{sidebar.email}</span>
              </span>
            </a>
            <div className="flex items-start gap-3">
              ...
              <span>
                ...
                <span className="block text-sm text-[#c93239] dark:text-white leading-snug">{sidebar.address}</span>
              </span>
            </div>
            <div className="flex items-start gap-3">
              <span className="w-9 h-9 bg-[#c93239] rounded-lg flex items-center justify-center shrink-0">
              ...
              <span>
                ...
                <span className="block text-sm text-[#c93239] dark:text-white">{sidebar.hours}</span>
              </span>
            </div>
          </div>
        </div>

        <div className="rounded-2xl overflow-hidden h-48 bg-[#c93239]/10 dark:bg-white/5 flex items-center justify-center border border-gray-100 dark:border-white/10">
        ...
        <div className="bg-[#c93239] rounded-2xl p-5 text-center">
