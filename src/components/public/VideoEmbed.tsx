...
export default function VideoEmbed({
  ...
  if (external && !allowed) {
    return (
      <div className="rounded-2xl overflow-hidden bg-[#c93239]/10 dark:bg-white/5 aspect-video relative border border-gray-100 dark:border-white/10">
        {thumbnail ? (
  ...
  return (
    <div className="rounded-2xl overflow-hidden bg-[#c93239]/10 dark:bg-white/5 aspect-video relative border border-gray-100 dark:border-white/10 group">
