        ...
        <div className="flex items-center justify-between h-16 md:h-[4.5rem]">
          ...
          <Link href={localizedHref(locale, "home")} className="flex items-center gap-3 shrink-0">
            ...
            {/* <span className="hidden sm:block">
              <span className="block text-[#c93239] font-bold text-sm leading-tight font-['Montserrat']">
                {ui.brandLine1}
              </span>
          ...
          <div className="flex items-center gap-1.5">
            <div className="relative">
              {searchOpen && (
                <input
                  ...
                  className="absolute right-10 top-1/2 -translate-y-1/2 w-56 bg-[#F3F4F6] border border-[#D4A843]/30 text-[#c93239] placeholder-[#c93239]/50 rounded-md px-3 py-1.5 text-sm focus:outline-none focus:border-[#D4A843]"
                />
              )}
              <button
                ...
                className="p-2 text-[#000]/80 hover:text-[#c93239] hover:bg-[#D4A843]/10 rounded-md transition-colors"
              >
                <Search size={18} />
              </button>
            </div>
            ...
            <Link
              ...
              className="hidden sm:inline-flex items-center gap-1.5 px-2 py-2 text-[#000]/80 hover:text-[#c93239] hover:bg-[#D4A843]/10 rounded-md transition-colors text-xs font-semibold uppercase"
            >
              <Languages size={16} />
              {other}
            </Link>
            ...
            {/* <button
              ...
              className="p-2 text-[#c93239]/80 hover:text-[#c93239] hover:bg-[#D4A843]/10 rounded-md transition-colors"
            ...
            <button
              ...
              className="md:hidden p-2 text-[#c93239]/80 hover:text-[#c93239]"
            ...
            return (
              <Link
                ...
                className={`px-4 py-2.5 rounded-md text-sm font-medium transition-colors ${isActive(href)
                    ? "bg-[#D4A843] text-[#c93239]"
                    : "text-[#c93239]/80 hover:text-[#c93239] hover:bg-[#D4A843]/10"
                  }`}
              >
                {link.label}
              </Link>
