    ...
    <>
      ...
      {shareOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" role="dialog" aria-modal="true" aria-label={ui.common.share}>
          ...
          <div className="relative bg-white dark:bg-[#c93239] rounded-2xl p-6 w-80 shadow-2xl">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-bold text-[#c93239] dark:text-white font-['Montserrat']">{ui.common.share}</h3>
            ...
            <button onClick={copy} className="mt-3 w-full flex items-center justify-center gap-2 border border-gray-200 dark:border-white/20 rounded-xl py-2.5 text-sm font-medium text-[#c93239] dark:text-white hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
