...
export function ProjectCardSkeleton() {
  return (
    <div className="bg-white dark:bg-[#c93239]/30 rounded-2xl overflow-hidden border border-gray-100 dark:border-white/10">
...
export function ListRowSkeleton() {
  return (
    <div className="bg-white dark:bg-[#c93239]/30 border border-gray-100 dark:border-white/10 rounded-xl p-4 flex items-center gap-4">
...
export function FeatureSlideSkeleton() {
  return (
    <div className="grid md:grid-cols-2 gap-0 bg-white dark:bg-[#c93239]/30 rounded-2xl overflow-hidden border border-gray-100 dark:border-white/10">
...
export function StatCardSkeleton() {
  return (
    <div className="bg-white dark:bg-[#c93239]/40 rounded-2xl p-6 border border-gray-100 dark:border-white/10 flex flex-col items-center gap-3">
