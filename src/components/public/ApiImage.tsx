  ...
  if (!url) {
    return (
      <div
        role="img"
        aria-label={alt}
        className={`h-full w-full bg-gradient-to-br from-[#c93239]/15 via-[#D4A843]/10 to-[#E8821A]/15 dark:from-white/10 dark:via-white/5 dark:to-white/10 flex items-center justify-center ${className ?? ""}`}
      >
        {fallbackLabel ? (
