          ...
          {projects.map((p) => {
            ...
            return (
              <div key={p.id} className="min-w-full">
                <div className="grid md:grid-cols-2 bg-white dark:bg-[#c93239]/30 rounded-2xl overflow-hidden shadow-[0_4px_12px_rgba(0,0,0,0.08)] border border-gray-100 dark:border-white/10">
                  ...
                  <div className="p-6 sm:p-8 flex flex-col justify-between">
                    <div>
                      <span className="inline-block bg-[#c93239]/8 dark:bg-white/10 text-[#c93239] dark:text-white/80 text-xs font-medium px-3 py-1 rounded-full mb-3">
                        {catalogName(p.sector, locale)}
                      </span>
                      <h3 className="text-xl font-bold text-[#c93239] dark:text-white font-['Montserrat'] mb-2 leading-tight">{title}</h3>
      ...
      {count > 1 && (
        <>
          <button
            ...
            className="absolute left-3 top-1/2 -translate-y-1/2 w-10 h-10 bg-white dark:bg-[#c93239] shadow-lg rounded-full flex items-center justify-center text-[#c93239] dark:text-white hover:bg-[#D4A843] hover:text-white dark:hover:bg-[#D4A843] transition-colors z-10"
          >
            <ChevronLeft size={20} />
          </button>
          <button
            ...
            className="absolute right-3 top-1/2 -translate-y-1/2 w-10 h-10 bg-white dark:bg-[#c93239] shadow-lg rounded-full flex items-center justify-center text-[#c93239] dark:text-white hover:bg-[#D4A843] hover:text-white dark:hover:bg-[#D4A843] transition-colors z-10"
          >
