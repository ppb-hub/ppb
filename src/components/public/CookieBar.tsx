...
export default function CookieBar({ locale, ui }: { locale: Locale; ui: UiStrings }) {
  ...
  return (
    <div
      ...
      className="no-print fixed bottom-0 left-0 right-0 z-50 bg-[#c93239] border-t border-[#D4A843]/30 shadow-lg"
    >
      ...
      {settingsOpen && (
        <div className="border-t border-white/10 bg-[#c93239] px-4 sm:px-6 py-5">
