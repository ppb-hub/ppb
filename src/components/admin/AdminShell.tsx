  ...
  return (
    <AuthCtx.Provider value={{ user, checking, error, doLogout }}>
      <div className="min-h-screen bg-[#F8F9FA] dark:bg-[#0a1628] text-[#1a2332] dark:text-white">
        <div className="flex">
          {/* Sidebar */}
          <aside className="hidden lg:flex w-64 shrink-0 min-h-screen flex-col bg-[#c93239] text-white sticky top-0 h-screen">
            <Link href="/admin" className="flex items-center gap-3 px-5 h-16 border-b border-white/10">
              <span className="w-9 h-9 rounded-lg bg-[#D4A843] flex items-center justify-center">
                <span className="text-[#c93239] font-bold text-xs font-['Montserrat']">GPB</span>
              </span>
              <span>
                      ...
                      return (
                        <Link
                          ...
                          className={cx(
                            ...
                            active ? "bg-[#D4A843] text-[#c93239] font-semibold" : "text-white/75 hover:text-white hover:bg-white/10"
                          )}
                        >
          ...
          <div className="flex-1 min-w-0">
            <header className="sticky top-0 z-40 bg-white/90 dark:bg-[#0a1628]/90 backdrop-blur border-b border-gray-100 dark:border-white/10 h-14 px-4 sm:px-6 flex items-center justify-between gap-3">
              ...
              <div className="ml-auto flex items-center gap-2">
                <Link href="/pt" target="_blank" className="text-xs text-[#c93239] dark:text-white/70 hover:text-[#E8821A] underline underline-offset-2">
                  Ver site
                </Link>
                <button
  ...
  return (
    <div className="lg:hidden flex items-center gap-3 min-w-0">
      <select
        ...
        className="max-w-[46vw] text-sm border border-gray-200 dark:border-white/20 bg-white dark:bg-[#c93239] rounded-lg px-2 py-1.5"
        onChange={(e) => {
