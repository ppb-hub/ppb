              ...
              <div className="grid sm:grid-cols-[190px_1fr] gap-5">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-1 pt-1">
                    <button onClick={() => move(i, -1)} disabled={i === 0} aria-label="Mover para cima" className="p-2 rounded-lg text-gray-500 hover:text-[#c93239] hover:bg-gray-100 dark:hover:bg-white/10 disabled:opacity-30 transition-colors">
                      <ArrowUp size={15} />
                    </button>
                    <button onClick={() => move(i, 1)} disabled={i === rows.length - 1} aria-label="Mover para baixo" className="p-2 rounded-lg text-gray-500 hover:text-[#c93239] hover:bg-gray-100 dark:hover:bg-white/10 disabled:opacity-30 transition-colors">
                      <ArrowDown size={15} />
                    </button>
